...
//        cfg.setClassLoaderForTemplateLoading(ResourcesOps.class.getClassLoader(), "/" + rootFolder);
...
public class TemplateEngine {
    ...
    public TemplateEngine(String rootFolder) {
        cfg = new Configuration(Configuration.VERSION_2_3_33);
        // Загружаем шаблоны из папки rootFolder внутри ресурсов (classpath)
        cfg.setClassLoaderForTemplateLoading(getClass().getClassLoader(), "/" + rootFolder);
    }
